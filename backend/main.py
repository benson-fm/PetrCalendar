...
file = 'C:\\Users\\benso\\Projects\\PetrCalendar\\week10_drops.png'

def get_data(file_path: Path):
    """returns the data from the file going through the ocr"""
    payload = {'isOverlayRequired': True,
            'apikey': OCR_API_KEY,
            }

    with open(file_path, 'rb') as f:
        r = requests.post(BASE_OCR_URL, 
                        files={str(file_path): f},
                        data=payload)
